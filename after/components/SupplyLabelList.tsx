...
import { numberWithCommas, prettyEthAddress } from "your-utilities-path"; // Replace with actual import paths
import { AppIcon } from "./AppIcon";

export const SupplyLabelList = ({
  walletChain,
  statsSupplies,
  allSupplies,
  chainTokenSymbols,
  ...
  return (
    <div className="supply_label_list">
      ...
      <div>
        ...
        {/* Mini Supply Values for Other Chains */}
        {allSupplies
